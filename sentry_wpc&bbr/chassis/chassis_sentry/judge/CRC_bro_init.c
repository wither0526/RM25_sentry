...
////?????????????0??255?????16CRC§µ?????????????????1????????????
////gEnpoly?????????
////?????¦Ë????????????????????(??¦Ë???¦Ë????)????CRC16-CCITT?0x1021????????0x8408
...
//			for(j=8;j>0;j--)
//			{
//				if(cRc_16&0x8000)                 //????cRc_16&0x0001
//					 cRc_16=(cRc_16<<=1)^gEnpoly;  //????cRc_16=(cRc_16>>=1)^gEnpoly
//				else
//					 cRc_16<<=1;                   //????cRc_16>>=1
//			}
